...
export const crewObj = {
  곤이: {
    ...
    prevStudyPairs: ['그루밍', '도비', '디토 피터', '브랜', '지그', '체프', '하루'],
  ...
  디토: {
    ...
    prevStudyPairs: ['도비', '곤이', '피터', '유조', '체프', '지그', '콜린'],
  ...
  브랜: {
    ...
    prevStudyPairs: ['미키', '인치', '썬', '곤이', '피터', '하루', '그루밍', '체프'],
  ...
  썬: {
    ...
    prevStudyPairs: ['유조', '미키', '브랜', '피터', '그루밍', '카일', '도비', '크리스'],
  ...
  유조: {
    ...
    prevStudyPairs: ['썬', '지그', '미키', '디토', '콜린', '하루', '도비'],
  ...
  지그: {
    ...
    prevStudyPairs: ['인치', '체프', '유조', '콜린', '카일', '곤이', '디토'],
  ...
  콜린: {
    ...
    prevStudyPairs: ['카일', '지그', '그루밍', '하루', '유조', '피터', '디토'],
  ...
  피터: {
    ...
    prevStudyPairs: ['하루', '파노', '디토', '곤이', '썬', '브랜', '콜린', '카일'],
  ...
  하루: {
    ...
    prevStudyPairs: ['피터', '그루밍', '파노', '크리스', '유조, 콜린', '브랜', '곤이'],
