...
export const crewObj = {
  곤이: {
    ...
    prevStudyPairs: ['그루밍', '도비', '디토 피터', '브랜', '지그', '체프', '하루', '유조', '서니'],
  ...
  유조: {
    ...
    prevStudyPairs: ['썬', '지그', '미키', '디토', '콜린', '하루', '도비', '곤이', '브랜'],
  ...
  지그: {
    ...
    prevStudyPairs: ['인치', '체프', '유조', '콜린', '카일', '곤이', '디토', '썬', '하루'],
  ...
  크리스: {
    ...
    prevStudyPairs: ['파노', '카일', '체프', '하루', '도비', '그루밍', '썬', '서니', '크리스'],
  ...
  피터: {
    ...
    prevStudyPairs: ['하루', '파노', '디토', '곤이', '썬', '브랜', '콜린', '카일', '도비', '크리스'],
  ...
  하루: {
    ...
    prevStudyPairs: ['피터', '그루밍', '파노', '크리스', '유조, 콜린', '브랜', '곤이', '디토', '지그'],
